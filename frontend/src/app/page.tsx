        ...
        <section id="projects" className="py-24 px-6 bg-surface-dark">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <FadeIn delay={0.3} className="bg-white/5 rounded-2xl overflow-hidden border border-white/10 hover:border-accent/50 transition-colors flex flex-col">
                <div className="relative w-full h-48 bg-white/5">
                  <Image
                    src="/images/OutbreakIQ.png"
                    alt="OutbreakIQ — project screenshot"
                    fill
                    className="object-cover"
                  />
                </div>
                <div className="p-8 flex flex-col flex-grow">
                  ...
                  <div className="flex flex-wrap gap-4">
                    <Link href="https://healthintelligence.vercel.app" target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-accent hover:text-white transition-colors">View Live Demo &rarr;</Link>
                    <Link href="https://github.com/SummarRajpoot/OutbreakIQ_frontend" target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-white/60 hover:text-white transition-colors">Frontend &rarr;</Link>
                    <Link href="https://github.com/SummarRajpoot/OutbreakIQ_backend" target="_blank" rel="noopener noreferrer" className="text-sm font-semibold text-white/60 hover:text-white transition-colors">Backend &rarr;</Link>
                  </div>
                </div>
              </FadeIn>
